...
public final class FileService2 extends BaseApiService2 {

    private final IFileService sServiceInstance;
    private final String rootPath;

    public FileService2(IFileService service) {
        sServiceInstance = service;
